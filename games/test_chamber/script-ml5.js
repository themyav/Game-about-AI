const optionsModel = {
    dataUrl: './resources/train-5000.csv',
    // Long line
...
let nn = ml5.neuralNetwork(optionsModel, modelLoaded)

function modelLoaded() {
    console.log('Data loaded');
    nn.normalizeData();
    console.log('Data normalized');
    nn.train(optionsTrain, whileTraining, doneTraining);

}

function whileTraining(epoch, loss) {
    console.log(`epoch: ${epoch}, acc:${loss.acc}, loss:${loss.loss}`);
}
